...
def update_lease(id):
    ...
    lease.propertyid = data.get('propertyid', lease.propertyid)
    lease.leasetermstart = data.get('leasetermstart', lease.leasetermstart)
    lease.leasetermend = data.get('leasetermend', lease.leasetermend)
